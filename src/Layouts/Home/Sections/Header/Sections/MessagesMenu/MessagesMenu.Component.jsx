...
const transaltionPath = 'MessagesMenuComponent.';
export const MessagesMenuComponent = memo(() => {
    ...
    <div className='cards'>
      <div className='card-content-'>
        ...
        <div className='d-flex-column-center main-title-staus'>
          <span className='mx-3'>{t(`${transaltionPath}Messages`)}</span>
        </div>
      </div>
      <div className='card-content-MessagesMenuComponent'>
        <div className='Notification-wraper'>
          ...
          <div className='Notification-from'>
            <div className='d-inline-flex'>
              ...
              <div className='Notification-msg'> 4 days ago</div>{' '}
            </div>
            <span className='Notification-time'> feed back of projct </span>
          </div>
        </div>
        <div className='separator-h' />
        <Button className='w-100'>
          {' '}
          <span className='create-states'>{t(`${transaltionPath}see-your-all-Messages`)}</span>
        </Button>
        <div className='separator-h' />
...
MessagesMenuComponent.displayName = 'MessagesMenuComponent';
MessagesMenuComponent.propTypes = {};
