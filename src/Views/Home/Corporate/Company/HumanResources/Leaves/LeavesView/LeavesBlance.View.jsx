...
import LeavesBlanceData from '../../../../../../../StaticJOSN/LeavesBlanceData.json';
import '../Leaves.Style.scss';
import { DialogComponent, Inputs } from '../../../../../../../Components';
import { LeavesBlanceTabel } from '../LeaveTabelView/LeavesBlanceTabel';
import { NoSearchResultComponent } from '../../../../../../../Components/NoSearchResultComponent/NoSearchResultComponent';

const parentTranslationPath = 'LeavesBlanceView';
const translationPath = '';
export const LeavesBlanceView = () => {
  const { t } = useTranslation(parentTranslationPath);
  // eslint-disable-next-line no-unused-vars
  const [ViewType, setViewType] = useState(1);
  const [employees, setEmployees] = useState(LeavesBlanceData);
  ...
  const FilterHandlerMyAttendance = (value) => {
    const result = LeavesBlanceData.result.filter((item) =>
